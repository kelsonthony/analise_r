...
gerar_trajetoria <- function(input_path = "TABELAS_coleta_HRT.xlsx",
                             output_xlsx = "trajetoria.xlsx",
                             output_csv = "Trajetoria_neonatos.csv",
                             limite_semanas = 30) {
  ...
  message("Trajetória gerada com sucesso: ", output_xlsx)
}
